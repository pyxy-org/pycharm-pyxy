...
internal class PyxyHighlighter(languageLevel: LanguageLevel) : PyHighlighter(languageLevel) {
    ...
    override fun getTokenHighlights(tokenType: IElementType): Array<TextAttributesKey> {
        ...
        val color = colorForTokenType[tokenType]
        return pack(pythonTextAttributesKeys, color)
    }
    ...
    companion object {
        ...
        init {
            colorForTokenType[PyxyElementTypes.TAG_EXPRESSION] = PyxyHighlighterColors.PYXY_EMBEDDED

            colorForTokenType[PyxlTokenTypes.TAGBEGIN] = PyxyHighlighterColors.PYXY_TAG
